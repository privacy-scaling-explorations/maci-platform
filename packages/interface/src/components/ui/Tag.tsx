...
export const Tag = createComponent(
  "div",
  tv({
    base: "cursor-pointer font-sans font-sans inline-flex items-center border border-blue-500 justify-center gap-2 text-blue-500 whitespace-nowrap transition hover:bg-blue-50",
    variants: {
      size: {
