      ...
      <section className="md:max-w-screen-sm lg:max-w-screen-md xl:max-w-screen-lg">
        ...
        <Card variant="invert">
          ...
          <div className="mt-2 flex w-full flex-col items-center justify-center gap-2 sm:flex-row sm:gap-4">
            <Button
              as={Link}
              href={`https://x.com/intent/tweet?text=I+successfully+submit+my+vote+in+${round?.roundId}+round.`}
              size="auto"
              target="_blank"
              variant="tertiary"
            >
            ...
            <Button
              as={Link}
              href={`https://www.threads.net/intent/post?text=I+successfully+submit+my+vote+in+${round?.roundId}+round.`}
              size="auto"
              target="_blank"
              variant="tertiary"
            >
            ...
            <Button
              as={Link}
              href={`https://warpcast.com/~/compose?text=I+successfully+submit+my+vote+in+${round?.roundId}+round.`}
              size="auto"
              target="_blank"
              variant="tertiary"
            >
